...
```{r}
lowerBound_M = DeltaSD_lowerBound_M(betahat = LWdata_EventStudy$betahat, 
                                    sigma = LWdata_EventStudy$sigma, 
                                    numPrePeriods = numPrePeriods)
upperBound_M = DeltaSD_upperBound_Mpre(betahat = LWdata_EventStudy$betahat, 
                                       sigma = LWdata_EventStudy$sigma, 
                                    numPrePeriods = numPrePeriods)
```
